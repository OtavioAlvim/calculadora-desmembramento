...
$sql = "SELECT * FROM desmembramento LEFT JOIN itens_desmembramento on desmembramento.id_formula = itens_desmembramento.id_desmembramento where desmembramento.status = 'A'";
...
<form class="row g-3">
            <div class="col-md-3">
                <label for="inputEmail4" class="form-label"><p><strong>NOME DA FORMULA:</strong><?php echo strtoupper($dados[0]['nome_formula'])?></p></label>
                <!-- <input type="text" class="form-control" id="inputEmail4" placeholder="CORTARAM O ALICATE" disabled> -->
            </div>
            <div class="col-md-3">
                <label for="inputPassword4" class="form-label"><p><strong>CUSTO TOTAL PRODUTO:</strong> R$: <?php echo  number_format($dados[0]['custo_total'],2,',','')?></p></label>
                <!-- <input type="number" step="0,02" class="form-control" id="inputPassword4" placeholder="" disabled> -->
            </div>
            <div class="col-md-3">
                <label for="inputAddress" class="form-label"><p><strong>PESO TOTAL DO PRODUTO:</strong> <?php echo  number_format($dados[0]['peso_total'],2,',','')?> KG</p> </label>
        ...
        <table class="table text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo  number_format($dados['porcentagem_custo'],2,',','')?></td>
                    <td><?php echo  number_format($dados['porcentagem_quantidade'],2,',','')?></td>
        ...
        <h1 class="text-center mt-3">TOTAL DA PERDA R$ <?php echo  number_format($dados['perda'],2,',','')?>%</h1>